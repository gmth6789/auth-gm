import { getCurrentInstance, version, ref, inject, watchEffect, watch, toRef, isRef, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, computed, isReadonly, defineAsyncComponent, withCtx, nextTick, openBlock, createElementBlock, mergeProps, resolveComponent, resolveDirective, withDirectives, renderSlot, normalizeClass, createBlock, createCommentVNode, createElementVNode, toDisplayString, Teleport, Fragment as Fragment$1, normalizeProps, TransitionGroup, renderList, Transition, vShow, normalizeStyle, toHandlers, defineComponent, h, Suspense, createStaticVNode } from 'vue';
...
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'h3';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-962a3181.mjs').then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/login-e0d0e469.mjs').then((m) => m.default || m)
  },
  {
    name: "private",
    path: "/private",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/private-5611c125.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-5c809d18.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-0c1e0c57.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-e55a58f7.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useUser as a, useCookie as b, createError as c, useRequestFetch as d, entry$1 as default, useHead as e, useRouter as f, navigateTo as n, useNuxtApp as u };
